...
\restrict TVemz6TOm9zhmiHOFCoIEc12LxuBB1N67TuvAUue2FIEq4LJLjjO3Qut2S2Idmx
...
COPY auth.contracts (id, organization_id, status, start_date, end_date) FROM stdin;
\.
...
COPY auth.organizations (id, name, org_type) FROM stdin;
\.
...
COPY auth.roles (id, name) FROM stdin;
1	admin
2	user
\.
...
COPY auth.user_organizations (user_id, organization_id) FROM stdin;
\.
...
COPY auth.users (id, email, password_hash, full_name, is_active, created_at, updated_at) FROM stdin;
1	admin@gravport.test	$2y$10$2toA8QUz7krpCfeaVwkgS.dIxYMmS0V0413dBDZSDqfulBb.fSoui	Super Admin	t	2026-02-06 16:14:33.317766	\N
2	client@gravport.test	$2y$10$keZ3yvWKitEzmn9ivYz8uegG/VzpbQCmbDai4ofYu9j1JjB10TIXm	Client Demo	t	2026-02-06 16:15:38.296846	\N
18	chanwaltz0404@gmail.com	$2a$12$PA4CXYCgTgEYBYrDTYI0juogsZt54vxZN1mOq.A.ov4WZfpu/soqG	Chan Waltz	t	2026-05-09 19:29:03.720781	2026-05-09 19:29:03.720781
\.
...
COPY public.cba_l1_id (id, line_name, value_cba, geom) FROM stdin;
1	LRT Segment 1	10.5	0101000020E6100000D95F764F1EB65A40849ECDAACFD518C0
2	LRT Segment 2	12.3	0101000020E610000014D044D8F0B45A40A4DFBE0E9CB318C0
3	LRT Segment 3	9.8	0101000020E6100000083D9B559FE75A40EC51B81E85AB1BC0
4	LRT Segment 4	11.1	0101000020E6100000CFF753E3A5975B4058CA32C4B12E1FC0
5	LRT Segment 5	13.0	0101000020E61000008E75711B0D305C4048E17A14AE071DC0
\.
...
COPY public.geo_datasets (id, title, country_code, country_name, is_downloadable, is_viewable, spatial_scope, download_url, view_url, created_at, backend_type, data_schema, data_table, geom_column) FROM stdin;
2	Scatter FAA Level 1 - DKI Jakarta	ID	Indonesia	t	t	regional	https://example.com/download/faa_l1_jakarta	https://example.com/view/faa_l1_jakarta	2025-12-06 13:14:04.174737	table	public	cba_l1_id	geom
3	Scatter CBA Level 1 - Indonesia	ID	Indonesia	t	t	national	https://example.com/download/cba_l1_id	https://example.com/view/cba_l1_id	2025-12-06 13:14:04.174737	table	public	cba_l1_id	geom
1	Scatter FAA Level 1 - Indonesia	ID	Indonesia	t	t	national	https://example.com/download/faa_l1_id	https://example.com/view/faa_l1_id	2025-12-06 13:14:04.174737	table	public	cba_l1_id	geom
\.
...
COPY public.gravity_level1_points (objectid, namobj, kjkgn, wktgbt, mtdp, koordy, koordx, helips, hortho, gybrt, tgf, faa, cba, std, remark, geom) FROM stdin;
\.
...
1	2026-01-29-170151	App\\Database\\Migrations\\CreateUsersTable	mockup	App	1769706868	1
\.
...
1	superadmin	admin@gravport.test	$2y$10$96GRUbSLX64NVoCvQal0auM7G/p9WA5W9jMuFF3t.HddlIGqMdieS	admin	t	2026-01-29 17:19:49	2026-01-29 17:19:49
2	client_demo	client@gravport.test	$2y$10$FnhSIny.TfhMdCArSjIXkuFrakffM7Jr45h4qRU0ugOhsb5xoK1rS	user	t	2026-01-29 17:19:49	2026-01-29 17:19:49
\.
...
\unrestrict TVemz6TOm9zhmiHOFCoIEc12LxuBB1N67TuvAUue2FIEq4LJLjjO3Qut2S2Idmx
